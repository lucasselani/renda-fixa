...
import com.lambreta.rendafixa.features.bonds.data.mapper.groupByDealer
...
class BondsService(private val bondsApi: BondsApi,
    ...
    override fun bonds(): Either<Failure, Map<String, List<BondDomainModel>>> =
            request(context, bondsApi.bonds(), { it.groupByDealer() }, BondsResponse())
}